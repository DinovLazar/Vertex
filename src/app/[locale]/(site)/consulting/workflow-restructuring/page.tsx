...
const SLUG = 'workflow-restructuring'
...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: 'consulting.workflowRestructuring.meta',
  })
...
export default async function WorkflowRestructuringPage({
  params,
}: {
  params: Promise<{ locale: Locale }>
}) {
  ...
  const t = await getTranslations({
    locale,
    namespace: 'consulting.workflowRestructuring',
  })
